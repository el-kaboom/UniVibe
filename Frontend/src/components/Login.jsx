...
export const FormInput = ({ label, type, placeholder, inputRef }) => {
    return (
...
export const FormBody = ({ emailRef, passwordRef, buttonRef, handleButtonClick }) => {
    return (
        <div className="card max-w-sm shadow-2xl bg-base-100 p-4 md:p-8 gap-4 mx-auto">
            <FormInput label="Email" type="text" placeholder="Email" inputRef={emailRef} />
            <FormInput label="Password" type="password" placeholder="Password" inputRef={passwordRef} />
